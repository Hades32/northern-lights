exports.Planetcalc = new function () {
  ...
  this.Calculate318 = function (___inp___) {
    ...
    var Calculate318_result = {};

    function __impl__(__inp__) {
      var day = typeof (__inp__["day"]) == "undefined" ? "" : __inp__["day"];
      var plat = typeof (__inp__["plat"]) == "undefined" ? 55.75 : __inp__["plat"];
      var plon = typeof (__inp__["plon"]) == "undefined" ? 37.616666666667 : __inp__["plon"];
      var gmtdiff = typeof (__inp__["gmtdiff"]) == "undefined" ? 4 : __inp__["gmtdiff"];
      var azimuth = {
        "SetValue": function (v) {
          Calculate318_result["azimuth"] = v;
        }
      };
      var altitude = {
        "SetValue": function (v) {
          Calculate318_result["altitude"] = v;
        }
      };
